    ...
    <nav className={`bg-na fixed top-0 left-0 w-full ${navClass} z-50`}>
      <div className="flex items-center justify-between  max-w-screen-xl mx-auto relative">
        <Link to="" className="flex items-center space-x-3 rtl:space-x-reverse">
          <span className="text-4xl font-semibold whitespace-nowrap dark:text-white text-white bg-[#2C3E50] ">
            START FRAMEWORK
          </span>
        </Link>
        <button
        ...
        <div
          className={`absolute top-full left-0 w-full bg-white bg-na md:static md:flex md:w-auto ${
            isOpen ? "block" : "hidden"
          } md:block`}
        >
          <ul className="font-medium flex flex-col md:flex-row md:space-x-8 rtl:space-x-reverse  bg-na dark:border-gray-700">
            <li>
              <NavLink
                to="/about"
                className="block  dark:text-white text-xl text-white p-2 bg-[#2C3E50]"
              >
                About
              </NavLink>
            </li>
            ...
            <li>
              <NavLink
                to="/contact"
                className="block p-2  dark:text-white text-xl text-white bg-[#2C3E50]"
              >
                Contact
              </NavLink>
            </li>
